...
const initialState = {
	products: [
		...
		{id: 'custom1', name: 'Potatissallad', amount: 100, fetched: {
			name: 'Potatissallad',
			amount: 1,
			kcal: 220,
			protein: 1.5,
			calcium: 					{name: 'Calcium, Ca', unit: 'mg', value: 6},
			iron: 						{name: 0, unit: 0, value: 0.2},
			magnesium: 				{name: 0, unit: 0, value: 16},
			phosphorus: 			{name: 0, unit: 0, value: 31},
			potassium: 				{name: 0, unit: 0, value: 256},
			sodium: 					{name: 0, unit: 0, value: 4},
			zinc: 						{name: 0, unit: 0, value: 0.2},
			copper: 					{name: 0, unit: 0, value: 0},
			manganese: 				{name: 0, unit: 0, value: 0},
			selenium: 				{name: 0, unit: 0, value: 0},
			fluoride: 				{name: 0, unit: 0, value: 0},
			vit_c: 						{name: 0, unit: 0, value: 5.8},
			thiamin: 					{name: 0, unit: 0, value: 0},
			riboflavin: 			{name: 0, unit: 0, value: 0},
			niacin: 					{name: 0, unit: 0, value: 1},
